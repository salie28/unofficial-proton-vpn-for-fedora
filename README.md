...
A desktop client that reuses Proton's own officially installed VPN backend and
lays it out the way their Windows app does: a map that follows your connection,
a live traffic chart, recents, and the settings you actually change kept one
click away.
